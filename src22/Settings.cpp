...
static auto g_szDescriptionSplitterPos = _T("DescriptionSplitterPos");
...
namespace
{
	...
	void GetSplitter(LPCTSTR szSection, int &value, int nDefault, LPCTSTR szKey = g_szSplitterPos)
	{
		Get(szSection, szKey, value);
...
AppSettings::AppSettings()
{
	...
	DescriptionSplitterPos = g_nSplitterPanel;
	ViewMode = 0;
...
void AppSettings::Load()
{
	...
	GetSplitter(strNormal, DescriptionSplitterPos, g_nSplitterPanel, g_szDescriptionSplitterPos);
...
void AppSettings::Save() const
{
	...
	Set(strNormal, g_szDescriptionSplitterPos, DescriptionSplitterPos);
