...
CommandInfo s_commands[] = {
	...
	{
		ImageIndex::ThumbnailNormal, ID_VIEW_FILMSTRIP, CUpdateUIBase::UPDUI_MENUPOPUP | CUpdateUIBase::UPDUI_TOOLBAR, 0, -1
	},
	{
...
// 2.2 changes mode from the vertical bar at the left edge (CModeBar), not from
// the head of every toolbar the way 2.3 does, so the toolbars carry only their
// own commands.
int s_toolbarMain[] = {
	ID_BROWSE_BACK,
	ID_BROWSE_FORWARD,
