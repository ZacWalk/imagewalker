...
public:
	...
	// Which pieces of a pane's gutter strip are up. Full screen keeps the zoom
	// controls and the navigator and drops the scroll bars.
	virtual bool CanShowGutterItem(DWORD id) const = 0;
